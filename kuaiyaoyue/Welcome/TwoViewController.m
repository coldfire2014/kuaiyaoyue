...
- (void)viewDidLoad {
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad) {
        ...
        UIImage* img = [[UIImage alloc] initWithContentsOfFile:[bundle pathForResource:@"2w" ofType:@"jpg"]];
        ...
        CGRect f = IPAD_FRAME;
        myImageView* bg2 = [[myImageView alloc] initWithFrame:f andImageName:@"2w.jpg" withScale:2.0 andAlign:UIImgAlignmentBottom];
