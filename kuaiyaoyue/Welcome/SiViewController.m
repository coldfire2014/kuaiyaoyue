...
//  kuaiyaoyue
//
//  Created by wuyangbing on 14/12/30.
...
- (void)viewDidLoad {
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad) {
        ...
        UIImage* img = [[UIImage alloc] initWithContentsOfFile:[bundle pathForResource:@"4w" ofType:@"jpg"]];
        ...
        CGRect f = IPAD_FRAME;
        myImageView* bg2 = [[myImageView alloc] initWithFrame:f andImageName:@"4w.jpg" withScale:2.0 andAlign:UIImgAlignmentBottom];
...
//        [filter setDefaults];
        ...
        myImageView* bg = [[myImageView alloc] initWithFrame:self.view.bounds andImageName:@"4w.jpg" withScale:2.0 andAlign:UIImgAlignmentCenter];
        [self.view addSubview:bg];
        myImageView* qq_btn = [[myImageView alloc] initWithFrame:CGRectMake(0, 0, 227.0/2.0, 59.0/2.0) andImageName:@"btn5s" withScale:2.0];
        qq_btn.tag = 101;
