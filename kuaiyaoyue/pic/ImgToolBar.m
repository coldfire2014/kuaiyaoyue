...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        layer.colors = [[NSArray alloc] initWithObjects:
                        (id)[[UIColor alloc] initWithRed:75.0/255.0 green:75.0/255.0 blue:75.0/255.0 alpha:0.3].CGColor,
                        (id)[[UIColor alloc] initWithRed:25.0/255.0 green:25.0/255.0 blue:25.0/255.0 alpha:0.1].CGColor, nil];
